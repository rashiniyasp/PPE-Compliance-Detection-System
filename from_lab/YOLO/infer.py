...
def parse_args():
    ...
    parser.add_argument("--weights", type=str, default="/data/Rashi/Systech/runs/detect/runs/train/ppe_detection/weights/best.pt", help="Path to trained YOLO weights")
